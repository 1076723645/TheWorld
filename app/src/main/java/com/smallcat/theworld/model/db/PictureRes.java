...
public class PictureRes {
    ...
    private static final int imgList0[] = new int[]{R.drawable.ruanbu, R.drawable.jingliang,R.drawable.zhen_ruanbu,R.drawable.zhen_jingliang
            ...
            ,R.drawable.wuqi_15,R.drawable.wuqi_16,R.drawable.wuqi_17,R.drawable.wuqi_18,R.drawable.wuqi_19,R.drawable.wuqi_14,R.drawable.wuqi_15
            ...
            ,R.drawable.wuqi_158,R.drawable.wuqi_159,R.drawable.wuqi_160};
    ...
    private static final int imgList3[] = new int[]{R.drawable.nail_1,R.drawable.nail_2,R.drawable.nail_3,R.drawable.nail_4,R.drawable.nail_5
            ...
            ,R.drawable.nail_48,R.drawable.nail_49};
    ...
    private static final int imgList4[] = new int[]{R.drawable.ship_1,R.drawable.ship_2,R.drawable.ship_3,R.drawable.ship_4,R.drawable.ship_5
            ...
            ,R.drawable.ship_55,R.drawable.ship_56,R.drawable.ship_57,R.drawable.ship_58,R.drawable.ship_59};
    ...
    private static final int imgList[] = new int[]{R.drawable.chib_1,R.drawable.chib_2,R.drawable.chib_3,R.drawable.chib_4,R.drawable.chib_5
            ,R.drawable.chib_6,R.drawable.chib_7,R.drawable.chib_8,R.drawable.chib_9,R.drawable.chib_10,R.drawable.chib_11,R.drawable.chib_12
            ,R.drawable.chib_13,R.drawable.chib_14,R.drawable.chib_15,R.drawable.chib_16,R.drawable.chib_18,R.drawable.chib_19
    ...
    private static final int cailList[] = new int[]{R.drawable.cail_0,R.drawable.cail_1,R.drawable.cail_2,R.drawable.cail_3,R.drawable.cail_4,R.drawable.cail_5
            ...
            ,R.drawable.cail_20,R.drawable.cail_21,R.drawable.cail_22,R.drawable.cail_23,R.drawable.cail_24,R.drawable.cail_25,R.drawable.cail_26
